# 🚀 Upwork Landing Page Clone (UI/UX Practice)
...
* **Complex Navigation Bar:** Includes inline search inputs, hover states, and call-to-action buttons (Log In / Sign Up).
* **Clean Layout:** Strict adherence to a clean, maintainable external CSS file without relying on heavy frameworks like Bootstrap or Tailwind.
